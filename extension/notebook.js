...
$("stSpk").addEventListener("click", () => { const it = theCardHienTai(); if (it) speakJa(it.word); });
...
async function backupJson() {
  ...
  download("njdict-sotay-backup.json",
