@echo off
REM ================================================================
REM  Cap nhat NJDict tu GitHub (keo code moi nhat ve may).
REM  Bam doi chuot vao file nay moi khi muon cap nhat.
REM  Sau do vao chrome://extensions bam nut "Update" (hoac nut reload
REM  vong tron mui ten tren the NJDict) la ban moi chay ngay.
REM  (Extension nap tu thu muc con "extension" ben trong thu muc nay.)
REM ================================================================
cd /d "%~dp0"
echo.
...
echo      hoac nut reload tren the NJDict.
echo ================================================================
echo.
pause
