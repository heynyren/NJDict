/**
 * ĐỒNG BỘ SỔ TAY "Tra Mazii nhanh" QUA GOOGLE DRIVE
 * -------------------------------------------------
 * Cách dùng:
 ...
 *    (ví dụ: "mazii-nhien-2026-x7k"). ĐỪNG dùng mật khẩu Google của bạn ở đây.
 ...
 *
 * LƯU Ý: file này còn lo cả chức năng DỊCH CÂU (dùng Google Dịch qua LanguageApp).
 * Nếu bạn đã deploy bản cũ, hãy dán đè code mới này rồi Deploy -> Manage deployments
 * -> sửa deployment hiện có -> chọn "New version" -> Deploy. URL giữ nguyên, không phải dán lại.
 *
...
var FILE_NAME = "mazii-notebook.json";       // tên file lưu trên Drive (có thể giữ nguyên)
